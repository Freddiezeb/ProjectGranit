...
function arduino_due_1(result)
{
    ...
    //        $.getScript("/Code/temperatureChart.js", function(){
    //            temperatureChart(result); 
    //        });
    //    temp = new temperatureChart();
    //    temp.temperatureChart(result);
    temperatureChart(result);
...
function temperatureChart(result)
{
